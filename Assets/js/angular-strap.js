...
(function (window, document, undefined) {
    ...
    angular.module('mgcrea.ngStrap.datepicker', ['mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.tooltip'])
      ...
      .provider('$datepicker', function () {
          ...
          this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "datepickerViews", "$tooltipng", function ($window, $document, $rootScope, $sce, $locale, dateFilter, datepickerViews, $tooltip) {
    ...
    angular.module('mgcrea.ngStrap.dropdown', ['mgcrea.ngStrap.tooltip'])
      ...
      .provider('$dropdown', function () {
          ...
          this.$get = ["$window", "$rootScope", "$tooltipng", function ($window, $rootScope, $tooltip) {
    ...
    angular.module('mgcrea.ngStrap.popover', ['mgcrea.ngStrap.tooltip'])
      ...
      .provider('$popoverng', function () {
          ...
          this.$get = ["$tooltipng", function ($tooltip) {
      ...
      .directive('csString', ["$rootScope", "$window", "$compile", "$sce", "$popoverng", function ($rootScope, $window, $compile, $sce, $popover) {
          ...
          return {
              ...
              link: function postLink(scope, element, attr) {
                  ...
                  scope.validateForm = function (myform) {
                      ...
                      if (myform.$invalid) return false;
                   ...
                   scope.save=function(data)
                    {
                        scope.btmodel =(S(data.Type.connectionStringTemplate).template(data).s);
                          scope.bttype=data.Type.type;
      ...
      .directive('bsPopover', ["$rootScope", "$window", "$sce", "$popoverng", function ($rootScope, $window, $sce, $popover) {
    ...
    angular.module('mgcrea.ngStrap.select', ['mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.helpers.parseOptions'])
      ...
      .provider('$select', function () {
          ...
          this.$get = ["$window", "$document", "$rootScope", "$tooltipng", function ($window, $document, $rootScope, $tooltip) {
    ...
    angular.module('mgcrea.ngStrap.timepicker', ['mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.tooltip'])
      ...
      .provider('$timepicker', function () {
          ...
          this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "$tooltipng", function ($window, $document, $rootScope, $sce, $locale, dateFilter, $tooltip) {
    ...
    angular.module('mgcrea.ngStrap.tooltip', ['mgcrea.ngStrap.helpers.dimensions'])
      ...
      .directive('bsTooltip', ["$window", "$location", "$sce", "$tooltipng", "$$rAF", function ($window, $location, $sce, $tooltip, $$rAF) {
