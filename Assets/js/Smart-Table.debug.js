...
angular.module("partials/globalSearchCell.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("partials/globalSearchCell.html",
      "<label><b>Search</b> :" +
      "<input class='form-control' type=\"text\"  ng-model=\"searchValue\"/></label>\n");
}]);
...
//      "    </tr>\n" +
//      "    </tbody>\n" +
//      "    <tfoot ng-show=\"isPaginationEnabled\" class='row-fluid'>\n" +
//      "    <tr class=\"dataTables_paginate paging_bootstrap pagination\">\n" +
...
//    var testcase = $templateCache.put("partials/smartTable.html");
//    console.log("<table class=\"smart-table\">\n" +
//      "    <thead>\n" +
//      "    <tr class=\"smart-table-global-search-row\" ng-show=\"isGlobalSearchActivated\">\n" +
//      "        <td class=\"smart-table-global-search\" column-span=\"{{columns.length}}\" colspan=\"{{columns.length}}\">\n" +
//      "        </td>\n" +
...
(function (angular) {
    ...
    angular.module('smartTable.templateUrlList', [])
        .constant('templateUrlList', {
            smartTable: 'partials/smartTableBitwise.html',
